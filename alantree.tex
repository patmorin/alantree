...
\begin{todo}
  Alan points out that this last statement is false.  Actually, the cost of this step is
  \[
     \min\{X_i + Y_i: i\in\{1,\ldots,d-\ell\} \}
  \]
  where $X_i\sim\exponential(1)$ and
  \[
     Y_i = \min\{A_{i,j}+B_{i,j} : j\in\{1,\ldots,ell^2\}\}
  \]
  is the minimum of $\ell^2$ $\erlang(2,1)$ random variables.  Is this enough?
\end{todo}
  \end{enumerate}
