...
Some of this work was carried out while Vida Dujmovic, Pat Morin, and
...
is the sum of the weights on the edges in $P$. The \emph{height},
...
\emph{first-passage percolation time} and plays an important role
in our results.
...
The remainder of this paper is organized as follows: \Secref{inequalities}
presents some basic facts about sums of independent exponential random
variables that we use throughout.  \Secref{upper-bounds} presents our
upper bounds on $h(T)$.  \Secref{lower-bounds} presents families of
graphs where $h(T)$ matches our upper bounds.
...
\[
    \Phi(G) = \min\left\{\Phi_k(G): k\in\{1,\ldots,\lfloor n/2\rfloor\}\right\}
\]
