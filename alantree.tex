...
Our main tool for proving upper bounds, \lemref{meta-theorem}, bounds $h(\tcal(G,s))$ in terms of the first-passage percolation cover time and the number of paths of  a given length starting at $s$.
